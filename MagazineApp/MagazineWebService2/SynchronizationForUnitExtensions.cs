...
namespace MagazineApp
{
    ...
    public static partial class SynchronizationForUnitExtensions
    {
            ...
            /// The operations group for this extension method.
            /// </param>
            public static IList<UnitsToSyncItem> GetAllUnitsToSync(this ISynchronizationForUnit operations)
            {
                return Task.Factory.StartNew(s => ((ISynchronizationForUnit)s).GetAllUnitsToSyncAsync(), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IList<UnitsToSyncItem>> GetAllUnitsToSyncAsync(this ISynchronizationForUnit operations, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetAllUnitsToSyncWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// <param name='units'>
            /// </param>
            public static object SynchronizeUnits(this ISynchronizationForUnit operations, IList<UnitsToSyncItem> units = default(IList<UnitsToSyncItem>))
            {
                return Task.Factory.StartNew(s => ((ISynchronizationForUnit)s).SynchronizeUnitsAsync(units), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> SynchronizeUnitsAsync(this ISynchronizationForUnit operations, IList<UnitsToSyncItem> units = default(IList<UnitsToSyncItem>), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.SynchronizeUnitsWithHttpMessagesAsync(units, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
